// Kompakter, server-gerenderter Banner mit der wichtigsten Stadt-Zahl:
// Brutto-Aufwand · Pro-Kopf. Wird auf der Maschinerie-Startseite über dem
// Graphen platziert, damit Bürger:innen die Bezugsgrösse sehen, bevor sie
// in die Detail-Knoten klicken. Bewusst kein Stadt-Netto: das liegt nahe
// bei null (Steuern zählen als Ertrag) und wäre als Headline irreführend.
//
...
export default function BudgetSummary({
  ...
  return (
    <aside
      ...
      className="fixed bottom-[48px] sm:bottom-auto sm:top-[64px] left-1/2 -translate-x-1/2 z-[8] pointer-events-none flex flex-wrap sm:flex-nowrap items-center justify-center gap-1.5 sm:gap-3 px-3.5 py-1.5 rounded-lg sm:rounded-full bg-[var(--color-panel)]/90 backdrop-blur-sm border border-[var(--color-line)] shadow text-[11px] w-[calc(100vw-24px)] sm:w-auto sm:max-w-[90vw]"
    >
